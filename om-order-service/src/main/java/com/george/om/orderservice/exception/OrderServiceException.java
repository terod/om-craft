...
import com.george.om.orderservice.config.PropertiesConfig;
...
public class OrderServiceException {
    ...
    @Autowired
    public OrderServiceException(PropertiesConfig propertiesConfig) {
        OrderServiceException.propertiesConfig = propertiesConfig;
    }
