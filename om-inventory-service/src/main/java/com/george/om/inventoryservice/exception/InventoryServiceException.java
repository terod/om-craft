...
import com.george.om.inventoryservice.config.PropertiesConfig;
...
public class InventoryServiceException {
    ...
    @Autowired
    public InventoryServiceException(PropertiesConfig propertiesConfig) {
        InventoryServiceException.propertiesConfig = propertiesConfig;
    }
